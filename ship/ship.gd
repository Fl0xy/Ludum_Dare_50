...
func _physics_process(delta):
	...
	$thruster_back/exhaust.visible = false
	$thruster_front/exhaust.visible = false
	$thruster_left1/exhaust.visible = false
	$thruster_left2/exhaust.visible = false
	$thruster_right1/exhaust.visible = false
	$thruster_right2/exhaust.visible = false
	$thruster_boost/exhaust.visible = false
	...
	if Input.is_action_pressed("ui_up"):
		...
		if Input.is_action_pressed("ui_boost"):
			...
			$thruster_boost/exhaust.visible = true
	if Input.is_action_pressed("ui_right"):
		...
		$thruster_right1/exhaust.visible = true
		$thruster_right2/exhaust.visible = true
	if Input.is_action_pressed("ui_left"):
		...
		$thruster_left1/exhaust.visible = true
		$thruster_left2/exhaust.visible = true
	if Input.is_action_pressed("ui_down"):
		apply_impulse(basis.xform($thruster_front.translation), basis.xform($thruster_front.thruster_vector))
		$thruster_front/exhaust.visible = true
